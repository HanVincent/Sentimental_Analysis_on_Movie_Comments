...
def parseData(fname):
  for l in urllib.request.urlopen(fname):
    yield eval(l)#return each instance as list
...
for d in data:#get each instance
  for w in d['review/text'].split():#using space to split each word
...
X = [feature(d) for d in data]#每個instance都會有自己的向量
